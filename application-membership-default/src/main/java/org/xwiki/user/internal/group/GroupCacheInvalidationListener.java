...
public class GroupCacheInvalidationListener extends AbstractEventListener
{
    ...
    {
        super(NAME, new WikiDeletedEvent(), new XObjectDeletedEvent(any(GROUPS_CLASSNAME)),
            new XObjectAddedEvent(any(GROUPS_CLASSNAME)), new XObjectUpdatedEvent(any(GROUPS_CLASSNAME)),
            new XObjectDeletedEvent(any(USERS_CLASSNAME)));
    }

    private static RegexEntityReference any(String classReference)
    {
